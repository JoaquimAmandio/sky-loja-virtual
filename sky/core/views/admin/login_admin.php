    ...
    <div class="container py-5">
        <div class="row py-5">
            ...
            <form class="col-md-9 m-auto my-2" method="post" role="form" action="?a=login_admin_submit">
                <div class="row">
                    <div class="mb-3">
                        <label for="inputsubject">Administrador</label>
                        <input type="email" class="form-control mt-1" id="email" name="text_administrador" placeholder="Admin" required>
                    </div>
                    <div class="mb-3">
